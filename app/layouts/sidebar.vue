  ...
  <nav class="fixed bottom-0 left-0 w-full lg:relative lg:w-24 bg-white/80
   dark:bg-nuxt-gray-900/80 backdrop-blur-xl border-t lg:border-t-0 lg:border-r
    border-nuxt-gray-200 dark:border-nuxt-gray-800 flex lg:flex-col items-center
     justify-between z-50 transition-all duration-300 h-15 md:h-20 lg:h-screen lg:py-8">
    
     <!-- Bagian Samping -->
    <div class="hidden lg:flex flex-col items-center gap-8 w-full">
    ...
    <!-- Bagian Bawah  -->
    <div class="flex lg:hidden items-center justify-between w-full px-0 md:px-4 relative h-full">
